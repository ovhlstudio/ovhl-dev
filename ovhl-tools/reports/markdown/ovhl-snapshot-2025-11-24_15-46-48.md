...
> **AI Advice:** Top-level table 'Bridge' detected. If this stores state, it will persist. Ensure it is stateless or a Constant.
...
### 🔴 Hardcoded Path (Maintenance Nightmare) (-10 pts)
> **AI Advice:** STOP! Direct pathing creates tight coupling. If you move folders, this breaks. Use **Loader** or **Context**.
