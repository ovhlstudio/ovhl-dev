...
- **Forbidden:**
  ...
  - ❌ Never use `script.Parent.Parent`. Use **Loader** or **Context**.
...
- **Unit Tests:** `tests/` -> `game.ReplicatedStorage.Tests` & `game.ServerScriptService.Tests`
