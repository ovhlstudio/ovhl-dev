...
**Generated:** 2025-11-24 11:25:39  
**Target Directories:** `src tests`  
**Git Info:** Branch: tools/node-porting | Commit: 9654ac2 | Modified files: 6  
**Structure:** 45 folders | 70 files (70 Lua/Luau, 0 other)  
**File Distribution:** Server: 15 (29K, 971 lines) | Client: 7 (15K, 487 lines) | Shared: 48 (101K, 2732 lines)  
**Total Size:** 389K  
...
### 📦 External Packages (Loader Analysis)
| Package Name | Status | References |
|---|---|---|
| **Fusion** | ✅ Active | 6 refs |
| **onyx-ui** | ✅ Active | 2 refs |
| **Packages** | ✅ Active | 1 refs |
...
### 🕷️ Module Coupling (Loader Usage)
- **Central Core Refs:** 29 files depend on Core modules directly.

## 🛡️ Deep Security Scan (Logic & Vuln)

Running Regex heuristics for Bad Practices...

✅ No obvious race conditions found.

### 🔓 Data Security & Leaks
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkBridge.luau:        return { Success=false, Error='Too Many Requests', Code=429 }`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkBridge.luau:        if not ok then return { Success=false, Error='Invalid Arguments', Code=400 } end`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkBridge.luau:            return { Success=false, Error='Internal Server Error' }`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkBridge.luau:    return { Success=false, Error='Service Not Bound' }`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Modules/Inventory/InventoryService.luau:        return { Success = false, Error = "Item unavailable" }`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Modules/Inventory/InventoryService.luau:    return { Success = false, Error = "Invalid Action" }`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau:        return { Success = false, Error = "E-403: Access Denied" }`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau:        return { Success = false, Error = "E-400: Invalid Argument" }`
- ⚠️ **Raw Error Exposure:** `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau:        return { Success = false, Error = "E-500: System Error" }`

- ⚠️ **Potential Global State:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/DataMigrator.luau:local DataMigrator = {}`
- ⚠️ **Potential Global State:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/DataMigrator.luau:local MIGRATIONS = {`
- ⚠️ **Potential Global State:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkGuard.luau:local SENSITIVE_KEYS = {`
- ⚠️ **Potential Global State:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/ServerKernel.luau:local Adapters = {`

## 🧹 Code Quality & Standards

### 📍 Path Management
- ❌ **Hardcoded Path:** `../ovhl-framework/src/ServerScriptService/OVHL/ServerRuntime.server.luau:require(game.ReplicatedStorage.OVHL.Bootstrap).StartServer()`
- ❌ **Hardcoded Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/ClientRuntime.client.luau:require(game.ReplicatedStorage.OVHL.Bootstrap).StartClient()`
✅ Path resolution is clean.

### 📜 API Contract & Telemetry
**Defined Network Endpoints:**
- `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Networking/Bridge.luau-	local rawArgs = { ... }`
- `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Networking/Bridge.luau-	local cleanArgs = {}`
- `../ovhl-framework/src/ReplicatedStorage/OVHL/Modules/Inventory/SharedConfig.luau-			GetItems = {`
- `../ovhl-framework/src/ReplicatedStorage/OVHL/Modules/Inventory/SharedConfig.luau-				RateLimit = { Max = 5, Interval = 1 },`
- `../ovhl-framework/src/ReplicatedStorage/OVHL/Modules/Inventory/SharedConfig.luau-				Args = {},`
- `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkBridge.luau-    local rawArgs = {...}`
- `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkBridge.luau-    local cleanArgs = {}`
- `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau-            SetRank = {`
- `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau-                RateLimit = { Max = 10, Interval = 60 },`
- `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau-                Args = { { name = "targetUserId", type = "number" }, { name = "rankId", type = "number" } }`
- `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau-            GetPlayers = {`

## 🎨 UI System

- **Framework:** Fusion Detected (34 refs)
- **UI Structure:** Component-Based Architecture (3 component folders found)

## ⚖️  Architecture Verdict (THE JUDGE)

### 🏁 Final Health Score: **90 / 100**

#### 📉 Penalty Breakdown:
- **CRITICAL** (-10): Missing CI/CD Pipeline

## 📡 Active Log Domains (Telemetry)

| Module / File | Logger Domain |
|---|---|
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Bootstrap.luau</strong> (17 lines, 493B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Bootstrap.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Config/LoggerConfig.luau</strong> (33 lines, 993B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Config/LoggerConfig.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Config/SystemPanelConfig.luau</strong> (37 lines, 926B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Config/SystemPanelConfig.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/ConfigSchema.luau</strong> (42 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/ConfigSchema.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Constants.luau</strong> (19 lines, 378B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Constants.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Context.luau</strong> (32 lines, 771B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Context.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Env.luau</strong> (23 lines, 384B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Env.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Framework.luau</strong> (85 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Framework.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/FrameworkTypes.luau</strong> (33 lines, 962B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/FrameworkTypes.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Loader.luau</strong> (132 lines, 4K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Loader.luau`
...
```lua
  ...
  48 |                 "[Loader] ❌ Path Error: '%s' not found in %s.\n   Available: %s", 
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Manifest.luau</strong> (21 lines, 444B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Manifest.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Networking/Bridge.luau</strong> (209 lines, 5K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Networking/Bridge.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Networking/Middleware.luau</strong> (32 lines, 954B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Networking/Middleware.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Networking/NetworkEnums.luau</strong> (18 lines, 428B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Networking/NetworkEnums.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/SharedConfigLoader.luau</strong> (39 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/SharedConfigLoader.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Signals.luau</strong> (27 lines, 590B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/Signals.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/SmartLogger.luau</strong> (96 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/SmartLogger.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/TypeValidator.luau</strong> (53 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Core/TypeValidator.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Modules/Inventory/SharedConfig.luau</strong> (65 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/Modules/Inventory/SharedConfig.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/ActionGuard.luau</strong> (57 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/ActionGuard.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/API.luau</strong> (45 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/API.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Assets.luau</strong> (14 lines, 433B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Assets.luau`
...
**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Bridges/Topbar.lua`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/AsyncButton.luau</strong> (74 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/AsyncButton.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/GridContainer.luau</strong> (36 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/GridContainer.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/ItemSlot.luau</strong> (154 lines, 6K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/ItemSlot.luau`
...
**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/ScreenWrapper.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartButton.luau</strong> (46 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartButton.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartText.luau</strong> (35 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartText.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartWindow.luau</strong> (106 lines, 5K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartWindow.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/Window.luau</strong> (47 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Components/Window.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Motion.luau</strong> (31 lines, 895B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Motion.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/MotionPresets.luau</strong> (103 lines, 3K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/MotionPresets.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/OVHLTheme.luau</strong> (52 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/OVHLTheme.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/SafeLoader.luau</strong> (47 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/SafeLoader.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Theme.luau</strong> (1 lines, 44B)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Theme.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Util.luau</strong> (38 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Foundation/Util.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/Inventory/InventoryView.luau</strong> (57 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Views/Inventory/InventoryView.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/Shop/ShopView.luau</strong> (43 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Views/Shop/ShopView.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/Components/ConfirmationDialog.luau</strong> (123 lines, 5K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Views/System/Components/ConfirmationDialog.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/Components/PlayerInspector.luau</strong> (139 lines, 7K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Views/System/Components/PlayerInspector.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/FrameworkPanelView.luau</strong> (82 lines, 4K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Views/System/FrameworkPanelView.luau`
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/Pages/PermissionPage.luau</strong> (144 lines, 12K)</summary>

**Full Path:** `../ovhl-framework/src/ReplicatedStorage/OVHL/UI/Views/System/Pages/PermissionPage.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Config/PermissionConfig.luau</strong> (8 lines, 173B)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Config/PermissionConfig.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/DataMigrator.luau</strong> (53 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/DataMigrator.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/NetworkBridge.luau</strong> (128 lines, 4K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkBridge.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/NetworkGuard.luau</strong> (97 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/NetworkGuard.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/Permissions/Adapters/HDAdmin.luau</strong> (53 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/Permissions/Adapters/HDAdmin.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/Permissions/Adapters/InternalDB.luau</strong> (25 lines, 642B)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/Permissions/Adapters/InternalDB.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/RateLimiter.luau</strong> (63 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/RateLimiter.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/ServerKernel.luau</strong> (87 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Core/ServerKernel.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Modules/Inventory/InventoryService.luau</strong> (61 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Modules/Inventory/InventoryService.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/ServerRuntime.server.luau</strong> (3 lines, 92B)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/ServerRuntime.server.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Services/DataManagerService.luau</strong> (123 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Services/DataManagerService.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Services/MonetizationService.luau</strong> (47 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Services/MonetizationService.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Services/PermissionService.luau</strong> (132 lines, 4K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/Services/PermissionService.luau`
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/TestRunner.server.luau</strong> (63 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/ServerScriptService/OVHL/TestRunner.server.luau`
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/ClientRuntime.client.luau</strong> (3 lines, 92B)</summary>

**Full Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/ClientRuntime.client.luau`
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Controllers/FrameworkController.luau</strong> (135 lines, 4K)</summary>

**Full Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/Controllers/FrameworkController.luau`
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Controllers/PermissionController.luau</strong> (32 lines, 834B)</summary>

**Full Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/Controllers/PermissionController.luau`
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Core/ClientKernel.luau</strong> (88 lines, 3K)</summary>

**Full Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/Core/ClientKernel.luau`
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Core/FinderService.luau</strong> (86 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/Core/FinderService.luau`
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Modules/Inventory/InventoryController.luau</strong> (91 lines, 2K)</summary>

**Full Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/Modules/Inventory/InventoryController.luau`
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/TestRunner.client.luau</strong> (52 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/src/StarterPlayer/StarterPlayerScripts/OVHL/TestRunner.client.luau`
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/Mocks/MockDataStore.luau</strong> (13 lines, 380B)</summary>

**Full Path:** `../ovhl-framework/tests/ReplicatedStorage/Mocks/MockDataStore.luau`
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/Mocks/MockPlayer.luau</strong> (13 lines, 505B)</summary>

**Full Path:** `../ovhl-framework/tests/ReplicatedStorage/Mocks/MockPlayer.luau`
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/OVHL/Core/Context.spec.luau</strong> (34 lines, 984B)</summary>

**Full Path:** `../ovhl-framework/tests/ReplicatedStorage/OVHL/Core/Context.spec.luau`
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/OVHL/Core/Loader.spec.luau</strong> (25 lines, 873B)</summary>

**Full Path:** `../ovhl-framework/tests/ReplicatedStorage/OVHL/Core/Loader.spec.luau`
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/OVHL/Core/SmartLogger.spec.luau</strong> (29 lines, 881B)</summary>

**Full Path:** `../ovhl-framework/tests/ReplicatedStorage/OVHL/Core/SmartLogger.spec.luau`
...
<details>
<summary><strong>🌙 tests/ServerScriptService/OVHL/Core/DataMigrator.spec.luau</strong> (28 lines, 1K)</summary>

**Full Path:** `../ovhl-framework/tests/ServerScriptService/OVHL/Core/DataMigrator.spec.luau`
