...
| **Git Info** | Branch: upgrade-loader | Commit: 6b0bccb* |
| **Analysis Time** | 0.32s |
---
...
│   │               └── 📁 System
│   │                   ├── 📁 Components
│   │                   │   ├── 🌙 ConfirmationDialog.luau
│   │                   │   └── 🌙 PlayerInspector.luau
│   │                   ├── 🌙 FrameworkPanelView.luau
│   │                   └── 📁 Pages
│   │                       └── 🌙 PermissionPage.luau
│   ├── 📁 ServerScriptService
│   │   └── 📁 OVHL
...
#### 🕰️ Git Stats
```diff
 .../2025-11-24/ovhl-snapshot-241125-11-25-38.md    | 5066 ------------------
 ovhl-framework/ovhl.config.json                    |   95 +-
 .../markdown/ovhl-snapshot-2025-11-24_17-43-55.md  | 5331 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_18-23-33.md  | 5320 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_18-26-28.md  | 5307 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_18-50-36.md  | 5351 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_18-58-55.md  | 5355 --------------------
 .../markdown/ovhl-snapshot-2025-11-24_19-00-10.md  | 5355 --------------------
 .../src/ReplicatedStorage/OVHL/Core/Context.luau   |    6 +-
 .../src/ReplicatedStorage/OVHL/Core/Framework.luau |   12 +-
 .../src/ReplicatedStorage/OVHL/Core/Loader.luau    |  267 +-
 .../OVHL/Core/Networking/Bridge.luau               |    4 +-
 .../OVHL/Core/Networking/Middleware.luau           |    2 +-
 .../OVHL/Core/SharedConfigLoader.luau              |    2 +-
 .../src/ReplicatedStorage/OVHL/Core/Signals.luau   |    2 +-
 .../ReplicatedStorage/OVHL/Core/SmartLogger.luau   |    2 +-
 .../ReplicatedStorage/OVHL/UI/Foundation/API.luau  |   18 +-
 .../OVHL/UI/Foundation/ActionGuard.luau            |    2 +-
 .../OVHL/UI/Foundation/Bridges/Topbar.lua          |    6 +-
 .../OVHL/UI/Foundation/Components/AsyncButton.luau |    2 +-
 .../OVHL/UI/Foundation/Components/SmartButton.luau |    2 +-
 .../OVHL/UI/Foundation/Components/Window.luau      |    2 +-
 .../OVHL/UI/Foundation/Motion.luau                 |    2 +-
 .../OVHL/UI/Foundation/MotionPresets.luau          |    4 +-
 .../OVHL/UI/Foundation/OVHLTheme.luau              |    6 +-
 .../OVHL/UI/Foundation/SafeLoader.luau             |    4 +-
 .../OVHL/UI/Views/Inventory/InventoryView.luau     |    2 +-
 .../OVHL/UI/Views/Shop/ShopView.luau               |    2 +-
 .../System/Components/ConfirmationDialog.luau      |    2 +-
 .../Views/System/Components/PlayerInspector.luau   |    2 +-
 .../OVHL/UI/Views/System/FrameworkPanelView.luau   |    2 +-
 .../OVHL/UI/Views/System/Pages/PermissionPage.luau |    2 +-
 .../OVHL/Core/NetworkBridge.luau                   |    2 +-
 .../OVHL/Core/ServerKernel.luau                    |    6 +-
 .../OVHL/Modules/Inventory/InventoryService.luau   |  104 +-
 .../OVHL/Services/DataManagerService.luau          |    4 +-
 .../OVHL/TestRunner.server.luau                    |    2 +-
 .../OVHL/Controllers/FrameworkController.luau      |   10 +-
 .../OVHL/Core/ClientKernel.luau                    |   10 +-
 .../OVHL/Core/FinderService.luau                   |    2 +-
 .../Modules/Inventory/InventoryController.luau     |    6 +-
 .../OVHL/TestRunner.client.luau                    |    2 +-
 .../ReplicatedStorage/OVHL/Core/Context.spec.luau  |   24 +-
 .../ReplicatedStorage/OVHL/Core/Loader.spec.luau   |   34 +-
 .../OVHL/Core/SmartLogger.spec.luau                |   14 +-
 .../OVHL/Core/DataMigrator.spec.luau               |   54 +-
 ovhl-tools/ovhl.config.json                        |   95 +-
 .../markdown/ovhl-snapshot-2025-11-24_14-33-00.md  | 5289 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_14-41-04.md  | 5293 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_15-00-48.md  | 5304 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_15-18-49.md  | 5310 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_15-24-53.md  | 5319 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_15-38-30.md  | 5329 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_15-46-48.md  | 5340 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_15-53-20.md  | 5324 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_16-05-28.md  | 5317 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_16-11-41.md  | 5305 -------------------
 ovhl-tools/src/CLI/Commands/Init.ts                |   88 +-
 .../src/Features/Analyzers/01_Structure.ts.bak     |  116 -
 .../src/Features/Analyzers/02_Dependencies.ts      |  242 +-
 .../src/Features/Analyzers/02_Dependencies.ts.bak  |   48 -
 .../src/Features/Analyzers/03_Security.ts.bak      |   76 -
 .../src/Features/Analyzers/04_CodeQuality.ts       |  158 +-
 .../src/Features/Analyzers/04_CodeQuality.ts.bak   |   74 -
 .../src/Features/Analyzers/05_UIStack.ts.bak       |   69 -
 .../src/Features/Analyzers/06_Telemetry.ts.bak     |   73 -
 .../Features/Analyzers/07_BreakingChanges.ts.bak   |   72 -
 .../src/Features/Analyzers/08_Reusability.ts.bak   |   50 -
 ovhl-tools/src/Services/ConfigService.ts           |  185 +-
 ovhl-tools/src/Services/WallyService.ts            |  121 +-
 ovhl-tools/src/Types/Config.d.ts                   |   61 +-
 71 files changed, 1004 insertions(+), 91465 deletions(-)
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Config/LoggerConfig.luau</strong> (34 lines, 993 Bytes)</summary>
...
```lua
  ...
  25 | 
  26 |     Levels = {
  27 |         DEBUG    = { Weight=1, Icon="🔍" },
  28 |         INFO     = { Weight=2, Icon="ℹ️" },
  29 |         WARN     = { Weight=3, Icon="⚠️" },
  30 |         ERROR    = { Weight=4, Icon="❌" },
  31 |         CRITICAL = { Weight=5, Icon="💀" }
  32 |     }
  33 | }
  34 | 
```
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/ActionGuard.luau</strong> (58 lines, 1.87 KB)</summary>
...
```lua
   ...
   6 | local Signals = Loader.Get("Signals")
   7 | 
   8 | local ActionGuard = {}
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/API.luau</strong> (46 lines, 1.32 KB)</summary>
...
```lua
   ...
   6 | local Onyx = Loader.Get("Onyx")
   7 | 
   8 | local Assets = Loader.Get("Assets")
   9 | local Motion = Loader.Get("Motion")
  10 | local MotionPresets = Loader.Get("MotionPresets")
  11 | local Theme = Loader.Get("Theme")
  12 | local Util = Loader.Get("Util")
  13 | local SafeLoader = Loader.Get("SafeLoader")
  14 | 
  15 | local API = {}
  16 | 
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Assets.luau</strong> (15 lines, 433 Bytes)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Motion.luau</strong> (32 lines, 895 Bytes)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/MotionPresets.luau</strong> (104 lines, 3.65 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/OVHLTheme.luau</strong> (53 lines, 1.6 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/SafeLoader.luau</strong> (48 lines, 1.47 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Theme.luau</strong> (2 lines, 44 Bytes)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Util.luau</strong> (39 lines, 1.32 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Bridges/Topbar.lua</strong> (81 lines, 2.38 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/AsyncButton.luau</strong> (75 lines, 2.71 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/GridContainer.luau</strong> (37 lines, 1.32 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/ItemSlot.luau</strong> (155 lines, 6.71 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/ScreenWrapper.luau</strong> (52 lines, 1.53 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartButton.luau</strong> (47 lines, 1.58 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartText.luau</strong> (36 lines, 1.23 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/SmartWindow.luau</strong> (107 lines, 5.07 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/Window.luau</strong> (48 lines, 1.64 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/Inventory/InventoryView.luau</strong> (58 lines, 2.18 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/Shop/ShopView.luau</strong> (44 lines, 1.55 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/FrameworkPanelView.luau</strong> (83 lines, 4.27 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/Components/ConfirmationDialog.luau</strong> (124 lines, 5.34 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/Components/PlayerInspector.luau</strong> (140 lines, 7.61 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/Pages/PermissionPage.luau</strong> (145 lines, 12.49 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/ConfigSchema.luau</strong> (43 lines, 1.21 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Framework.luau</strong> (88 lines, 2.54 KB)</summary>
...
```lua
   ...
   9 | local ActionGuard = Loader.Get("ActionGuard")
  10 | local Bridge = Loader.Get("Bridge")
  11 | local Trove = Loader.Get("Trove") -- [NEW] Load Trove di Pusat
  12 | 
  13 | local Framework = {}
  14 | 
  ...
  32 | 			-- [FIXED] Tambahkan require() di sini!
  33 | 			return require(Loader.Module(ctrl.ConfigName).SharedConfig)
  34 | 		end)
  35 | 		if successA and resA then
  36 | 			loadedConfig = resA
  37 | 			loadSource = "Module"
  38 | 		else
  39 | 			-- [STRATEGY B] Cek di Global Config Folder (SystemPanelConfig)
  40 | 			-- Note: Loader.Config sudah otomatis require di dalam Proxy-nya, jadi ini aman.
  41 | 			local successB, resB = pcall(function()
  42 | 				return Loader.Config(ctrl.ConfigName)
  43 | 			end)
  44 | 			if successB and resB then
  45 | 				loadedConfig = resB
  46 | 				loadSource = "GlobalConfig"
  47 | 			end
  48 | 		end
  49 | 
  50 | 		-- [RESULT CHECK]
  51 | 		if loadedConfig then
  52 | 			ctrl.Config = loadedConfig
  53 | 			ctrl.Logger:Debug("ConfigLoaded", { Source = loadSource, Name = ctrl.ConfigName })
  54 | 		else
  55 | 			ctrl.Logger:Error("ConfigCritical", "FAILED TO LOAD CONFIG: " .. ctrl.ConfigName)
  56 | 			ctrl.Config = { Meta = { Error = "Missing" }, UI = {}, Topbar = {} }
  57 | 		end
  58 | 	end
  59 | 
  60 | 	-- 3. Lifecycle Wrapper
  61 | 	local originalInit = ctrl.Init
  62 | 	function ctrl:Init(ctx)
  63 | 		if originalInit then
  64 | 			-- Bungkus dengan pcall biar kalau Init error, gak matiin thread utama
  65 | 			local s, err = pcall(originalInit, self, ctx)
  66 | 			if not s then
  67 | 				ctrl.Logger:Error("InitCrash", err)
  68 | 			end
  69 | 		end
  70 | 	end
  71 | 
  72 | 	-- [NEW] Auto Cleanup Method
  73 | 	-- Framework sekarang punya standar cara mematikan Controller
  74 | 	function ctrl:Destroy()
  75 | 		if self.Shutdown then
  76 | 			self:Shutdown()
  77 | 		end -- Panggil custom shutdown user dulu
  78 | 		if self.Trove then
  79 | 			self.Trove:Destroy() -- Bersihkan sampah otomatis
  80 | 			self.Trove = nil
  81 | 		end
  82 | 	end
  83 | 
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Loader.luau</strong> (192 lines, 5.43 KB)</summary>

**Rojo Path:** `game.ReplicatedStorage.OVHL.Core.Loader`

```lua
   1 | --!strict
   2 | -- @Core: Loader v5.2 (Stable & Forgiving)
   3 | -- @Role: Central Dependency Registry
   ...
   9 | 
  10 | -- [0] DEBUGGER
  11 | local DEBUG_MODE = RunService:IsStudio()
  12 | local function log(msg: string, level: string?)
  13 | 	if not DEBUG_MODE then
  14 | 		return
  15 | 	end
  16 | 	local prefix = "[OVHL-LOADER]"
  17 | 	if level == "ERROR" then
  18 | 		warn(string.format("🔴 %s %s", prefix, msg))
  19 | 	elseif level == "WARN" then
  20 | 		warn(string.format("⚠️ %s %s", prefix, msg))
  21 | 	else
  22 | 		print(string.format("🔍 %s %s", prefix, msg))
  23 | 	end
  24 | end
  25 | 
  26 | -- [1] ROOT REFERENCES
  27 | local ROOTS = {
  28 | 	OVHL = ReplicatedStorage:WaitForChild("OVHL"),
  29 | 	Packages = ReplicatedStorage:WaitForChild("Packages"),
  30 | }
  31 | 
  32 | -- [HELPER] Wally Package Finder (Fixed)
  33 | local function findPkg(pkgName: string)
  34 | 	local exact = ROOTS.Packages:FindFirstChild(pkgName)
  35 | 	if exact then
  36 | 		return exact
  37 | 	end
  38 | 
  39 | 	local lowerName = pkgName:lower()
  40 | 	for _, child in ipairs(ROOTS.Packages:GetChildren()) do
  41 | 		local cName = child.Name:lower()
  42 | 		if
  43 | 			cName:find("_" .. lowerName .. "@", 1, true)
  44 | 			or cName:find("^" .. lowerName .. "@")
  45 | 			or cName:find(lowerName, 1, true)
  46 | 		then
  47 | 			return child
  48 | 		end
  49 | 	end
  ...
  54 | local ALIAS_MAP = {
  55 | 	-- CORE
  56 | 	["Framework"] = ROOTS.OVHL.Core.Framework,
  57 | 	["Context"] = ROOTS.OVHL.Core.Context,
  58 | 	["Logger"] = ROOTS.OVHL.Core.SmartLogger,
  59 | 	["Bridge"] = ROOTS.OVHL.Core.Networking.Bridge,
  60 | 	["Enums"] = ROOTS.OVHL.Core.Networking.NetworkEnums,
  61 | 	["Middleware"] = ROOTS.OVHL.Core.Networking.Middleware,
  62 | 	["Signals"] = ROOTS.OVHL.Core.Signals,
  63 | 	["Constants"] = ROOTS.OVHL.Core.Constants,
  64 | 	["Manifest"] = ROOTS.OVHL.Core.Manifest,
  65 | 	["Env"] = ROOTS.OVHL.Core.Env,
  66 | 	["Schema"] = ROOTS.OVHL.Core.ConfigSchema,
  67 | 	["ConfigLoader"] = ROOTS.OVHL.Core.SharedConfigLoader,
  68 | 	["TypeValidator"] = ROOTS.OVHL.Core.TypeValidator,
  69 | 
  70 | 	-- UI
  71 | 	["API"] = ROOTS.OVHL.UI.Foundation.API,
  72 | 	["Theme"] = ROOTS.OVHL.UI.Foundation.OVHLTheme,
  73 | 	["Assets"] = ROOTS.OVHL.UI.Foundation.Assets,
  74 | 	["ActionGuard"] = ROOTS.OVHL.UI.Foundation.ActionGuard,
  75 | 	["SafeLoader"] = ROOTS.OVHL.UI.Foundation.SafeLoader,
  76 | 	["Util"] = ROOTS.OVHL.UI.Foundation.Util,
  77 | 	["Motion"] = ROOTS.OVHL.UI.Foundation.Motion,
  78 | 	["MotionPresets"] = ROOTS.OVHL.UI.Foundation.MotionPresets,
  79 | 	["Topbar"] = ROOTS.OVHL.UI.Foundation.Bridges.Topbar,
  80 | 
  81 | 	-- PACKAGES
  82 | 	["Onyx"] = findPkg("onyx-ui"),
  83 | 	["TestEZ"] = findPkg("TestEZ"),
  84 | 	["Fusion"] = findPkg("Fusion"),
  85 | 	["Trove"] = findPkg("Trove"),
  86 | 	["Promise"] = findPkg("Promise"),
  87 | 	["Signal"] = findPkg("Signal"),
  88 | 	["ProfileService"] = findPkg("ProfileService"),
  89 | }
  90 | 
  91 | -- [3] FUZZY SEARCH
  92 | local function getDidYouMean(badName: string, validNames: { string })
  93 | 	local bestMatch = nil
  94 | 	local bestScore = 999
  95 | 	for _, name in ipairs(validNames) do
  96 | 		local score = math.abs(#name - #badName)
  97 | 		if name:lower():match(badName:lower()) then
  98 | 			score = score - 2
  99 | 		end
 100 | 		if score < 3 and score < bestScore then
 101 | 			bestScore = score
 102 | 			bestMatch = name
 103 | 		end
 104 | 	end
 ...
 107 | 
 108 | -- [4] PUBLIC API
 109 | function Loader.Get(aliasName: string)
 110 | 	local target = ALIAS_MAP[aliasName]
 111 | 	if target then
 112 | 		return require(target)
 113 | 	end
 114 | 
 115 | 	log("Alias '" .. aliasName .. "' not in Registry. Hunting in Packages...", "WARN")
 116 | 	local pkg = findPkg(aliasName)
 117 | 	if pkg then
 118 | 		log("✅ Auto-detected Package: " .. pkg.Name)
 119 | 		return require(pkg)
 120 | 	end
 121 | 
 122 | 	local keys = {}
 123 | 	for k in pairs(ALIAS_MAP) do
 124 | 		table.insert(keys, k)
 125 | 	end
 126 | 	local suggestion = getDidYouMean(aliasName, keys)
 127 | 	local msg = string.format("\n🛑 [OVHL-LOADER] Fatal Error: Module '%s' not found!", aliasName)
 128 | 	if suggestion then
 129 | 		msg = msg .. string.format("\n💡 Did you mean: '%s'?", suggestion)
 130 | 	end
 131 | 	log("❌ " .. msg, "ERROR")
 132 | 	error(msg, 2)
 133 | end
 134 | 
 135 | -- [5] LEGACY & COMPATIBILITY
 136 | local function createFolderProxy(folder)
 137 | 	return setmetatable({}, {
 138 | 		__index = function(_, key)
 139 | 			local target = folder:FindFirstChild(key)
 140 | 			if not target then
 141 | 				error("❌ '" .. key .. "' not found in " .. folder.Name)
 142 | 			end
 143 | 			if target:IsA("ModuleScript") then
 144 | 				return require(target)
 145 | 			end
 146 | 			return createFolderProxy(target)
 147 | 		end,
 148 | 		__call = function(_, pathStr)
 149 | 			local current = folder
 150 | 			for _, seg in ipairs(string.split(pathStr, "/")) do
 151 | 				current = current:FindFirstChild(seg)
 152 | 				if not current then
 153 | 					error("Path '" .. seg .. "' missing in " .. folder.Name)
 154 | 				end
 155 | 			end
 156 | 			return if current:IsA("ModuleScript") then require(current) else current
 157 | 		end,
 158 | 	})
 159 | end
 160 | 
 161 | Loader.UI = createFolderProxy(ROOTS.OVHL.UI)
 162 | Loader.Config = createFolderProxy(ROOTS.OVHL.Config)
 163 | Loader.Module = function(featureName)
 164 | 	return ROOTS.OVHL.Modules:FindFirstChild(featureName) or error("Module not found")
 165 | end
 166 | 
 167 | -- [SAFETY NET] Biar kode lama yang lolos refactor gak crash
 168 | Loader.Pkg = setmetatable({}, {
 169 | 	__call = function(_, name)
 170 | 		if name == "onyx-ui" then
 171 | 			return Loader.Get("Onyx")
 172 | 		end
 173 | 		return Loader.Get(name)
 174 | 	end,
 175 | })
 176 | 
 177 | if RunService:IsServer() then
 178 | 	local ServerRoot = ServerScriptService:WaitForChild("OVHL")
 179 | 	Loader.Server = function(pathStr)
 180 | 		local current = ServerRoot
 181 | 		for _, seg in ipairs(string.split(pathStr, "/")) do
 182 | 			current = current:FindFirstChild(seg)
 183 | 			if not current then
 184 | 				error("Server Path '" .. pathStr .. "' not found")
 185 | 			end
 186 | 		end
 187 | 		return require(current)
 188 | 	end
 189 | end
 190 | 
 191 | return Loader
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/SharedConfigLoader.luau</strong> (40 lines, 1.07 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Networking/Bridge.luau</strong> (210 lines, 5.68 KB)</summary>
...
```lua
   ...
   9 | local Promise = Loader.Get("Promise")
  10 | 
  11 | local Bridge = {}
  ...
  20 | 	TypeValidator = Loader.Get("TypeValidator")
  21 | end
  22 | 
  ...
  38 | 		self._services = {}
  39 | 
  40 | 		self._secLog:Info("System", "🛡️ Security Systems (Guard & Limiter) Connected")
  41 | 	else
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Networking/NetworkEnums.luau</strong> (19 lines, 428 Bytes)</summary>
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/TestRunner.server.luau</strong> (64 lines, 1.8 KB)</summary>
...
```lua
  ...
  27 | 		warn("⚠️ [SERVER] TesEZ not found! Please run 'wally install'.")
  28 | 		return
  29 | 	end
  30 | 
  ...
  43 | 		else
  44 | 			warn("⚠️ [SERVER] Missing Test Folder (Check Rojo Mapping)")
  45 | 		end
  46 | 	end
  47 | 
  48 | 	if #validRoots == 0 then
  49 | 		warn("⚠️ [SERVER] No tests found to run.")
  50 | 		return
  51 | 	end
  52 | 
  53 | 	-- 3. JALANIN TES!
  54 | 	print("📂 [SERVER] Scanning folders: " .. #validRoots)
  55 | 	local results = TesEZ.TestBootstrap:run(validRoots)
  56 | 
  57 | 	-- 4. Laporan
  58 | 	if results.failureCount > 0 then
  59 | 		warn("❌ [SERVER] FAILED: " .. results.failureCount .. " tests broken.")
  60 | 	else
  61 | 		print("✅ [SERVER] SUCCESS: All systems normal.")
  62 | 	end
  63 | end)
  64 | 
```
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/NetworkBridge.luau</strong> (129 lines, 4.65 KB)</summary>
...
```lua
   ...
   9 | local TypeValidator = Loader.Get("TypeValidator")
  10 | 
  11 | local Bridge = {}
  12 | Bridge.__index = Bridge
  13 | 
  ...
  31 |     self._secLog:Info("System", "🛡️ Security Systems (Guard & Limiter) Connected")
  32 |     
  33 |     return self
  34 | end
  35 | 
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/NetworkGuard.luau</strong> (98 lines, 2.78 KB)</summary>
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/RateLimiter.luau</strong> (64 lines, 1.75 KB)</summary>
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Core/ServerKernel.luau</strong> (88 lines, 2.31 KB)</summary>
...
```lua
   ...
   5 | 
   6 | local Context = Loader.Get("Context")
  ...
  82 | 	end
  83 | 
  84 | 	Log:Info("✅ SERVER BOOT COMPLETE")
  85 | end
  86 | 
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Services/DataManagerService.luau</strong> (124 lines, 2.89 KB)</summary>
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Services/PermissionService.luau</strong> (133 lines, 4.67 KB)</summary>
...
```lua
  ...
  33 |     self.Logger:Info("System", "🛡️ Permission System Initialized")
  34 | end
  35 | 
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Modules/Inventory/InventoryService.luau</strong> (82 lines, 2.36 KB)</summary>
...
```lua
   ...
   4 | local Loader = require(RS.OVHL.Core.Loader)
   5 | 
   6 | -- [FIX] Tambahkan require() disini!
   7 | local Cfg = require(Loader.Module("Inventory").SharedConfig)
   8 | 
   9 | local Hub = {}
  10 | 
  11 | function Hub:Init(ctx)
  12 | 	self.Logger = ctx:CreateLogger("INVENTORY")
  13 | 	self.Network = ctx.Network
  14 | 
  15 | 	-- [FIX] Move Data from Global to Instance
  16 | 	self._mockStorage = {
  17 | 		{ Id = 1, Name = "Excalibur", Rarity = "Epic", Count = 1, Icon = "rbxassetid://13006407439", Equipped = false },
  18 | 		{
  19 | 			Id = 2,
  20 | 			Name = "Health Potion",
  21 | 			Rarity = "Common",
  22 | 			Count = 5,
  23 | 			Icon = "rbxassetid://12905487363",
  24 | 			Equipped = false,
  25 | 		},
  26 | 		{ Id = 3, Name = "Mana Crystal", Rarity = "Rare", Count = 2, Icon = "", Equipped = false },
  27 | 		{ Id = 4, Name = "God Apple", Rarity = "Legendary", Count = 1, Icon = "", Equipped = false },
  28 | 		{
  29 | 			Id = 5,
  30 | 			Name = "Rusty Dagger",
  31 | 			Rarity = "Common",
  32 | 			Count = 1,
  33 | 			Icon = "rbxassetid://13006407439",
  34 | 			Equipped = false,
  35 | 		},
  36 | 	}
  37 | 
  38 | 	-- Sekarang Cfg.Network ada isinya, jadi Remote bakal dibuat!
  39 | 	self.Network:Register("Inventory", Cfg.Network)
  40 | 	self.Network:Bind("Inventory", self)
  41 | 
  42 | 	self.Logger:Info("System", "Inventory Active (Mock Storage)")
  43 | end
  44 | 
  45 | function Hub:Start() end
  46 | 
  47 | function Hub:GetItems(player)
  48 | 	-- Simulated fetch per player
  49 | 	self.Logger:Debug("Data", { User = player.Name, Op = "Fetch" })
  50 | 	return { Success = true, Data = self._mockStorage }
  51 | end
  52 | 
  53 | function Hub:PerformAction(player, itemId, action)
  54 | 	local targetItem, index
  55 | 	for i, v in ipairs(self._mockStorage) do
  56 | 		if v.Id == itemId then
  57 | 			targetItem = v
  58 | 			index = i
  59 | 			break
  60 | 		end
  61 | 	end
  62 | 
  63 | 	if not targetItem then
  64 | 		-- [FIX] Sanitized Error
  65 | 		return { Success = false, Error = "Item unavailable" }
  66 | 	end
  67 | 
  68 | 	if action == "Equip" then
  69 | 		targetItem.Equipped = not targetItem.Equipped
  70 | 		self.Logger:Info("Action", { User = player.Name, Type = action, Item = targetItem.Name })
  71 | 		return { Success = true, Data = { Msg = targetItem.Equipped and "Equipped" or "Unequipped" } }
  72 | 	elseif action == "Drop" then
  73 | 		table.remove(self._mockStorage, index)
  74 | 		self.Logger:Info("Action", { User = player.Name, Type = action, Item = targetItem.Name })
  75 | 		return { Success = true, Data = { Msg = "Item dropped" } }
  76 | 	end
  77 | 
  78 | 	return { Success = false, Error = "Invalid Action" }
  79 | end
  80 | 
  81 | return Hub
  82 | 
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/TestRunner.client.luau</strong> (53 lines, 1.4 KB)</summary>
...
```lua
  ...
  48 | 		warn("❌ [CLIENT] FAILED: " .. results.failureCount .. " tests broken.")
  49 | 	else
  50 | 		print("✅ [CLIENT] SUCCESS: UI & Controllers secure.")
  51 | 	end
  52 | end)
  53 | 
```
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Controllers/FrameworkController.luau</strong> (136 lines, 4.81 KB)</summary>
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Controllers/PermissionController.luau</strong> (33 lines, 834 Bytes)</summary>
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Core/ClientKernel.luau</strong> (89 lines, 3 KB)</summary>
...
```lua
   ...
   8 | local ConfigLoader = Loader.Get("ConfigLoader")
   9 | local Bridge = Loader.Get("Bridge")
  ...
  18 |     Log:Info(string.format("🎮 %s v%s (%s) CLIENT STARTING...", Manifest.Identity.Name, Manifest.Version.Full, Manifest.Metadata.BuildType))
  19 |     
  ...
  45 |     Log:Info("🔍 Scanning Client Modules...")
  ...
  82 |             end
  83 |         end
  84 |         Log:Info("✅ CLIENT BOOT COMPLETE")
  85 |     end)
  86 | end
  87 | 
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Modules/Inventory/InventoryController.luau</strong> (92 lines, 2.85 KB)</summary>
...
```lua
   ...
   6 | 
   7 | local UI = Loader.Get("API")
   8 | local Fusion = UI.Fusion
   9 | local Trove = Loader.Get("Trove")
  10 | local Topbar = Loader.Get("Topbar")
...
<details>
<summary><strong>🌙 tests/StarterPlayer/StarterPlayerScripts/OVHL/Modules/Inventory/InventoryController.spec.luau</strong> (64 lines, 2.19 KB)</summary>
...
```lua
   ...
   2 | 	local ReplicatedStorage = game:GetService("ReplicatedStorage")
   3 | 	local Loader = require(ReplicatedStorage.OVHL.Core.Loader)
   4 | 	local Promise = Loader.Get("Promise")
   5 | 
   6 | 	-- Load Controller Asli
   7 | 	-- Catatan: Di Framework V4, CreateController mengembalikan table controller.
  ...
  11 | 		-- [SETUP] Mocking Dependencies sebelum tes jalan
  12 | 		-- Kita pasang "Jebakan Batman" biar dia gak error nyari Server beneran
  13 | 		InventoryCtrl.Bridge = {
  14 | 			Request = function(self, service, method)
  15 | 				-- Pura-pura jadi Server yang ngebales sukses
  16 | 				if method == "GetItems" then
  17 | 					return Promise.resolve({ { Id = 1, Name = "MockSword" } })
  18 | 				end
  19 | 				return Promise.reject("Unknown Method")
  20 | 			end,
  21 | 			Listen = function() end, -- Mock Listen biar gak error
  22 | 		}
  23 | 
  24 | 		-- Mock Logger biar gak spam console
  25 | 		InventoryCtrl.Logger = { Info = function() end, Warn = function() end }
  26 | 
  27 | 		-- Mock State (Fusion Value)
  28 | 		-- Kita asumsi Init sudah jalan atau kita inject state manual jika perlu
  29 | 		-- Tapi InventoryCtrl.Init meload UI, ini bisa error di test environment tanpa PlayerGui.
  30 | 		-- Skenario terbaik: Pisahkan Logic dari UI Mounting.
  31 | 		-- Tapi untuk sekarang, kita tes function yang aman aja.
  32 | 
  33 | 		it("should be a valid controller table", function()
  34 | 			expect(InventoryCtrl).to.be.ok()
  35 | 			expect(InventoryCtrl.Name).to.equal("Inventory")
  36 | 		end)
  37 | 
  38 | 		it("should fetch data and update state", function()
  39 | 			-- Kita tes fungsi FetchData langsung
  40 | 			-- Karena kita sudah Mock Bridge di atas, dia gak bakal error network.
  41 | 
  42 | 			-- Inject State Manual (Mocking Fusion State)
  43 | 			local mockStateVal = {}
  44 | 			InventoryCtrl.State = {
  45 | 				Items = {
  46 | 					set = function(self, val)
  47 | 						mockStateVal = val
  48 | 					end,
  49 | 				},
  50 | 			}
  51 | 
  52 | 			-- Jalanin Logic
  53 | 			local p = InventoryCtrl:FetchData()
  54 | 
  55 | 			-- Tunggu Promise selesai
  56 | 			local success = p:awaitStatus()
  57 | 
  58 | 			expect(success).to.equal(Promise.Status.Resolved)
  59 | 			-- Cek apakah state berubah sesuai return dari Mock Bridge
  60 | 			expect(mockStateVal[1].Name).to.equal("MockSword")
  61 | 		end)
  62 | 	end)
  63 | end
  64 | 
...
<details>
<summary><strong>🌙 run.luau</strong> (2 lines, 4 Bytes)</summary>
