...
```diff
 ...
 ovhl-tools/run.cjs                                 |  958 ++--
 ovhl-tools/src/Core/ScoringEngine.ts               |   15 +-
 ovhl-tools/src/Features/Analyzers/01_Structure.ts  |   47 +-
 .../src/Features/Analyzers/02_Dependencies.ts      |   17 +-
 ovhl-tools/src/Features/Analyzers/03_Security.ts   |   29 +-
 .../src/Features/Analyzers/04_CodeQuality.ts       |   38 +-
 ...
 17 files changed, 790 insertions(+), 16955 deletions(-)
