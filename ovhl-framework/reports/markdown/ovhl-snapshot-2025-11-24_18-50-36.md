...
| **Git Info** | Branch: perbaikan-skor | Commit: 8e4f172* |
| **Analysis Time** | 0.29s |
---
...
> *   **Wally:** All external libs MUST be managed via `wally.toml`.
> *   **Dead Code:** Unused packages slow down Rojo sync. Remove them.
...
#### 🧠 AI KNOWLEDGE BASE
**❌ BAD:**
```lualocal Data = require(script.Parent.Parent.Services.DataService)```
**✅ GOOD (OVHL Standard):**
```lualocal Loader = require(ReplicatedStorage.OVHL.Core.Loader)
...
#### 🕰️ Git Stats
```diff
 ovhl-framework/ovhl.config.json                    |   89 +-
 .../json/ovhl-data-2025-11-24_17-30-39.json        |  297 --
 .../json/ovhl-data-2025-11-24_17-31-54.json        |  102 -
 .../markdown/ovhl-snapshot-2025-11-24_17-07-17.md  | 5309 -------------------
 .../markdown/ovhl-snapshot-2025-11-24_17-07-50.md  | 5310 --------------------
 .../markdown/ovhl-snapshot-2025-11-24_17-30-25.md  | 5310 --------------------
 .../markdown/ovhl-snapshot-2025-11-24_17-31-53.md  |  106 -
 ovhl-tools/run.cjs                                 |  957 ++--
 ovhl-tools/src/Core/ScoringEngine.ts               |   15 +-
 ovhl-tools/src/Features/Analyzers/01_Structure.ts  |   44 +-
 .../src/Features/Analyzers/02_Dependencies.ts      |   17 +-
 ovhl-tools/src/Features/Analyzers/03_Security.ts   |   32 +-
 .../src/Features/Analyzers/04_CodeQuality.ts       |   37 +-
 ovhl-tools/src/Features/Analyzers/05_UIStack.ts    |   20 +-
 ovhl-tools/src/Features/Analyzers/06_Telemetry.ts  |   55 +-
 .../src/Features/Analyzers/07_BreakingChanges.ts   |   27 +-
 .../src/Features/Analyzers/08_Reusability.ts       |   16 +-
 17 files changed, 789 insertions(+), 16954 deletions(-)
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Context.luau</strong> (33 lines, 771 Bytes)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Framework.luau</strong> (86 lines, 2.42 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Loader.luau</strong> (133 lines, 4.28 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/Core/Networking/Middleware.luau</strong> (33 lines, 954 Bytes)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/API.luau</strong> (46 lines, 1.37 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/MotionPresets.luau</strong> (104 lines, 3.66 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/OVHLTheme.luau</strong> (53 lines, 1.61 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Bridges/Topbar.lua</strong> (81 lines, 2.4 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Foundation/Components/Window.luau</strong> (48 lines, 1.65 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/Inventory/InventoryView.luau</strong> (58 lines, 2.19 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/FrameworkPanelView.luau</strong> (83 lines, 4.28 KB)</summary>
...
<details>
<summary><strong>🌙 src/ReplicatedStorage/OVHL/UI/Views/System/Pages/PermissionPage.luau</strong> (145 lines, 12.5 KB)</summary>
...
<details>
<summary><strong>🌙 src/ServerScriptService/OVHL/Modules/Inventory/InventoryService.luau</strong> (62 lines, 2.35 KB)</summary>
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Controllers/FrameworkController.luau</strong> (136 lines, 4.83 KB)</summary>
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Core/ClientKernel.luau</strong> (89 lines, 3.02 KB)</summary>
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Core/FinderService.luau</strong> (87 lines, 2.69 KB)</summary>
...
<details>
<summary><strong>🌙 src/StarterPlayer/StarterPlayerScripts/OVHL/Modules/Inventory/InventoryController.luau</strong> (92 lines, 2.87 KB)</summary>
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/OVHL/Core/Context.spec.luau</strong> (35 lines, 984 Bytes)</summary>
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/OVHL/Core/Loader.spec.luau</strong> (26 lines, 873 Bytes)</summary>
...
<details>
<summary><strong>🌙 tests/ReplicatedStorage/OVHL/Core/SmartLogger.spec.luau</strong> (30 lines, 881 Bytes)</summary>
...
<details>
<summary><strong>🌙 tests/ServerScriptService/OVHL/Core/DataMigrator.spec.luau</strong> (29 lines, 1.09 KB)</summary>
