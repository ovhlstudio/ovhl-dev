...
> **AI Advice:** This file controls logic but has NO EYES. Ensure it uses OVHL.CreateController OR implements :Init(ctx) to receive Logger.
...
```diff
 ...
 ovhl-tools/run.cjs                                 |  431 +-
 ovhl-tools/src/Core/ScoringEngine.ts               |   22 +-
 ovhl-tools/src/Features/Analyzers/03_Security.ts   |   28 +-
 ovhl-tools/src/Features/Analyzers/06_Telemetry.ts  |   50 +-
 11 files changed, 205 insertions(+), 16849 deletions(-)
